...
bool Cartridge::loadCartridge(char *cart) {
...
std::string Cartridge::getlicenseName() {
...
const char *Cartridge::getTypeName() {
...
Byte Cartridge::readCard(Word address) { return ctx.rom_data[address]; }
void Cartridge::writeCard(Word address, Byte value) { NO_IMPL }